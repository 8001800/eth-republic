...
contract("Traders", function () {
    it("can register and deregister", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, steps_1["default"].RegisterTrader(accounts_1.accounts[0], 1000)];
                    case 1:
                        _a.sent();
                        return [4, steps_1["default"].DeregisterTrader(accounts_1.accounts[0])];
                    case 2:
                        _a.sent();
                        return [2];
                }
    ...
    it("can register again", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, steps_1["default"].RegisterTrader(accounts_1.accounts[0], 1100)];
                    case 1:
                        _a.sent();
                        return [4, steps_1["default"].DeregisterTrader(accounts_1.accounts[0])];
                    case 2:
    ...
    it("can't deregister without first registering", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, steps_1["default"].DeregisterTrader(accounts_1.accounts[0])
    ...
    it("can access a bond from a republic ID", function () {
        return __awaiter(this, void 0, void 0, function () {
            var bond;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bond = 1111;
                        return [4, steps_1["default"].RegisterTrader(accounts_1.accounts[0], bond)];
                    case 1:
                        _a.sent();
                        return [4, steps_1["default"].GetTraderBond(accounts_1.accounts[0])];
                    case 2:
                        (_a.sent())
    ...
    it("should not have a bond after deregistering", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, steps_1["default"].RegisterTrader(accounts_1.accounts[0], 1000)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, steps_1["default"].RegisterTrader(accounts_1.accounts[0], 1000)
                                .should.be.rejectedWith(Error)];
                    case 2:
                        _a.sent();
                        return [4, steps_1["default"].DeregisterTrader(accounts_1.accounts[0])];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        newBond = 100;
                        return [4, steps_1["default"].UpdateTraderBond(accounts_1.accounts[0], newBond)];
                    case 3:
                        _a.sent();
                        return [4, steps_1["default"].GetTraderBond(accounts_1.accounts[0])];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        balanceBefore = (_a.sent());
                        oldBond = 1000;
                        return [4, steps_1["default"].RegisterTrader(accounts_1.accounts[0], oldBond)];
                    case 2:
                        _a.sent();
                        newBond = 1500;
                        return [4, steps_1["default"].ApproveRenToTraderRegistrar(accounts_1.accounts[0], newBond - oldBond)];
                    case 3:
                        _a.sent();
                        return [4, steps_1["default"].UpdateTraderBond(accounts_1.accounts[0], newBond)];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        newBond = 1500;
                        return [4, steps_1["default"].ApproveRenToTraderRegistrar(accounts_1.accounts[0], 0)];
                    case 3:
                        _a.sent();
                        return [4, steps_1["default"].UpdateTraderBond(accounts_1.accounts[0], newBond)
                                .should.be.rejectedWith(Error)];
    ...
    it("can retrieve a node's public key from its address", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, steps_1["default"].GetTraderPublicKey(accounts_1.accounts[0].republic)];
                    case 1:
                        (_a.sent())
...
//# sourceMappingURL=traderRegistrar.test.js.map